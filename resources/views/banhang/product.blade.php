...
@section('content')
	<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">{{$new_product->name}}</h6>	
			</div>
	...
	<div class="container">
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4">
						<img src="/source/image/product/{{$new_product->image}}" alt="{{ $new_product->name }}">
						</div>
						<div class="col-sm-8">
							<div class="single-item-body">
								<!-- <p class="single-item-title">{{$new_product->image}}</p> -->
								<p class="single-item-price">
								@if($new_product->promotion_price < $new_product->unit_price)
        ...
        @else
            <span>{{ number_format($new_product->unit_price) }} đồng</span>
        @endif
								</p>
							</div>

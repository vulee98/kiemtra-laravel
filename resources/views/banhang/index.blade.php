                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="{{ asset('product/'.$new_product->id)}}"><img src="/source/image/product/{{$new_product->image}}" alt="" height="250px"></a>
                                    </div>
									...
									<a class="add-to-cart pull-left" href="{{ route('banhang.addtocart',$new_product->id) }}"><i class="fa fa-shopping-cart"></i></a>
    									...
    									<a class="beta-btn primary" href="{{url('product/'.$new_product->id)}}">Chi tiết <i class="fa fa-chevron-right"></i></a>
